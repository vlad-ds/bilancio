...
@click.option('--dealer-share', type=float, default=0.0, help='Dealer initial inventory share (0 = agents own all claims)')
@click.option('--vbt-share', type=float, default=0.0, help='VBT initial inventory share (0 = agents own all claims)')
